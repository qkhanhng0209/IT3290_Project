...
def get_borrowed_books():
    ...
    try:
        ...
        """
        cursor.execute(check_query, (int(ticket_id),))
        ...
        query = """
            ...
            WHERE ct.MaPhieuMuon = ? AND ct.NgayTra IS NULL
            ORDER BY ct.MaSach
        """
...
def get_return_list():
    ...
    try:
        ...
        if condition:
            where_clause += " AND ct.TinhTrangTra = ?"
        ...
        count_query = f"""
            ...
            WHERE ct.NgayTra IS NOT NULL AND {where_clause}
        """
...
def get_return_detail(ma_phieu_muon):
    ...
    try:
        ...
        detail_query = """
            ...
            INNER JOIN DauSach ds ON ds.ISBN = cs.ISBN
            LEFT JOIN NXB nxb ON nxb.MaSoNXB = ds.MaSoNXB
            WHERE ct.MaPhieuMuon = ? AND ct.NgayTra IS NOT NULL
            ORDER BY ct.MaSach
        """
